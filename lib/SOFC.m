...
%         K_aug=acker(Aaug,Baug,pole_z_ctl_int)
     ...
     %% LQG Method for Controller
        C_Aug = [100*C_d 1]; % ??? cannot be used in LQR algorithm
        Q_ctl = C_Aug.'*C_Aug;
        R_ctl = 100;
        [K_aug,~,P_aug_ctl] = dlqr(Aaug,Baug,Q_ctl,R_ctl)
