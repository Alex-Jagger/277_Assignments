...
Loop=G*C;
 ...
 stepinfo(T)
 [Gm,Pm,Wcp,Wcg] = margin(Loop)  %These values should be checked against Nyquist or Bode plot of Loop=G*C
 figure
 rlocus(Loop)  %Root locus plot for 1+kGC=0, where k=1 is the designed PI controller C(s)
 sgrid
